...
>
  ...
  <div class="carousel-inner relative w-full overflow-hidden">
    ...
    <div class="carousel-item active relative float-left w-full">
      <img
        src="https://images.pexels.com/photos/2387630/pexels-photo-2387630.jpeg?auto=compress&cs=tinysrgb&w=600"
        class="block w-full h-[400px]"
        alt="Motorbike Smoke"
      />
      <div class="carousel-caption bg-gray-900 text-white hidden md:block absolute text-center">
    ...
    <div class="carousel-item relative float-left w-full">
      <img
        src="https://images.pexels.com/photos/212100/pexels-photo-212100.jpeg?auto=compress&cs=tinysrgb&w=600"
        class="block w-full h-[400px]"
        alt="Mountaintop"
      />
      <div class="carousel-caption bg-gray-900 text-white hidden md:block absolute text-center">
    ...
    <div class="carousel-item relative float-left w-full">
      <img
        src="https://images.pexels.com/photos/4480505/pexels-photo-4480505.jpeg?auto=compress&cs=tinysrgb&w=600"
        class="block w-full h-[400px]"
